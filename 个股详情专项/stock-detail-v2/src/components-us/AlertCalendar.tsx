...
import type { CalendarEvent } from "@/mock/stockDetail-us";
...
export function AlertCalendar({ events }: AlertCalendarProps) {
  return (
    <div className="flex items-center gap-3 border-b border-hairline bg-card-2 px-3 py-1.5 text-sm">
      ...
      <button type="button" aria-label="Open full calendar" className="caps shrink-0 text-accent transition-colors hover:underline">CAL →</button>
    </div>
  );
}
